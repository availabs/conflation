...
// SET DAMA TABLES
	...
	const insertSourceSql = `
		INSERT INTO data_manager.sources(name, type)
			VALUES('Checkpoint 3 Test', 'gis_dataset')
		RETURNING source_id;
	`;
	...
	const insertViewSql = `
		INSERT INTO data_manager.views(source_id, data_type, table_schema, table_name, data_table)
			VALUES(${ source_id }, 'gis_dataset', 'osm_datasets', 'checkpoint_3_test', 'osm_datasets.checkpoint_3_test')
		RETURNING view_id;
	`;
